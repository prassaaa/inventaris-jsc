...
<body class="hold-transition login-page" style="background-image: url('<?=base_url()?>src/img/bgg.jpg'); background-repeat: no-repeat; background-size: 100% 100%;">
...
<div class="login-box" style="margin-bottom: 80px">
  <div class="login-logo">
    <img src="<?=base_url()?>src/backend/dist/img/logo-jsc.png" class="logo" width="50%">
  </div>
  <!-- /.login-logo -->
  <div class="card">
